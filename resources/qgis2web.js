...
map.getView().fit([-1280897.994430, 5016677.900662, 2006353.494986, 6975878.310341], map.getSize());
    ...
    element: (() => {
        ...
        if (369 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '<marquee>Demonstration des possibilites de Qgis2web. </marquee><br /><br />Qgis2Web permet d’exporter un projet QGIS en carte web autonome : les couches et styles sont convertis en HTML/JavaScript (Leaflet ou OpenLayers).<br /><br /><img src="https://img.freepik.com/vecteurs-libre/grille-du-globe-terrestre_78370-7981.jpg?semt=ais_hybrid&w=740&q=80" alt="Image" height="100" width="130"><br />';
            }
